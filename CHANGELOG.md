...
- Appearance preview keeps MIUIX controls at their normal preview scale. Only the floating-navigation scene is clipped: the native 52 dp capsule remains intact while roughly 12 dp of bottom breathing room is retained, avoiding both the previous oversized navigation tail and a visually cramped edge.
