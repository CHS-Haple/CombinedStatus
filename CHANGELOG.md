...
- Debug builds temporarily map native dynamic-island motion through StatusBarIslandControllerImpl and IslandStretchAnimation with bounded change-only samples; the probe is read-only and performs no geometry writes.
