...
- The color preview now follows MIUIX's read-only color-preview hierarchy: a section title, non-clickable preview card, current mode summary, and three real theme-token swatches with a uniform 1 dp low-alpha outline.
