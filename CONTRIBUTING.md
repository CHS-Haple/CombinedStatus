...
After one requested one-time adoption is complete, later upstream revisions MUST NOT be pulled into the same already-validated branch. Evaluate them as a new upstream change with a new exact-revision gate.
